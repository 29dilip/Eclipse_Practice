...
public class MapDemo {
...

	{
		...
		// Map <Integer,String> ob=new HashMap<>(); //It will accept integer as key and
		// String as value
		...
		/*
		 * Set<Map.Entry<Integer,String>> map= ob.entrySet();//Entry is the inner
		 * interface inside Map just like inner class
		 * 
		 * 
		 * 
